            ...
            for (const opportunity of opportunities) {
                ...
                try {
                    for (var _b = (e_1 = void 0, __asyncValues(nango.paginate(Object.assign(Object.assign({}, config), { endpoint })))), _c; _c = yield _b.next(), !_c.done;) {
                        const interview = _c.value;
                        const mappedInterview = interview.map(mapInterview) || [];
                        // Save interviews
                        const batchSize = mappedInterview.length;
                        totalRecords += batchSize;
                        yield nango.log(`Saving batch of ${batchSize} interview(s) for opportunity ${opportunity.id} (total feedbacks: ${totalRecords})`);
                        yield nango.batchSave(mappedInterview, 'LeverOpportunityInterview');
                    }
                }
...
//# sourceMappingURL=opportunities-interviews.js.map