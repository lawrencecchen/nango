            ...
            for (const opportunity of opportunities) {
                ...
                try {
                    for (var _b = (e_1 = void 0, __asyncValues(nango.paginate(Object.assign(Object.assign({}, config), { endpoint })))), _c; _c = yield _b.next(), !_c.done;) {
                        const note = _c.value;
                        const mappedNote = note.map(mapNote) || [];
                        // Save notes
                        const batchSize = mappedNote.length;
                        totalRecords += batchSize;
                        yield nango.log(`Saving batch of ${batchSize} note(s) for opportunity ${opportunity.id} (total note(s): ${totalRecords})`);
                        yield nango.batchSave(mappedNote, 'LeverOpportunityNote');
                    }
                }
...
//# sourceMappingURL=opportunities-notes.js.map