...
export default function fetchData(nango) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (!finished) {
            ...
            const intercomConversationsPage = [];
            const intercomMessagesPage = [];
            for (const conversation of resp.data.conversations) {
                ...
                const conversationResp = yield nango.get({
                    baseUrlOverride: 'https://api.intercom.io/',
                ...
                intercomConversationsPage.push({
                    ...
                    contacts: conversationResp.data.contacts.contacts.map((contact) => {
            ...
            yield nango.batchSave(intercomConversationsPage, 'IntercomConversation');
            yield nango.batchSave(intercomMessagesPage, 'IntercomConversationMessage');
...
function mapMessagePartType(rawType) {
...
function mapAuthorType(rawType) {
    if (rawType === 'team') {
        return 'admin';
    }
