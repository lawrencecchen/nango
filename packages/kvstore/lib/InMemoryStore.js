...
export class InMemoryKVStore {
    ...
    set(key, value, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isExpired || (opts === null || opts === void 0 ? void 0 : opts.canOverride) || res === undefined) {
                this.store.set(key, { value: value, timestamp: Date.now(), ttlInMs: (opts === null || opts === void 0 ? void 0 : opts.ttlInMs) || 0 });
