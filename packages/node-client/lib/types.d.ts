...
export declare type FilterAction = 'added' | 'updated' | 'deleted' | 'ADDED' | 'UPDATED' | 'DELETED';
export declare type CombinedFilterAction = `${FilterAction},${FilterAction}`;
...
declare type AuthCredentials = OAuth2Credentials | OAuth1Credentials | BasicApiCredentials | ApiKeyCredentials | AppCredentials;
...
export declare type HTTP_VERB = 'GET' | 'POST' | 'PATCH' | 'PUT' | 'DELETE';
...
export declare type LastAction = 'ADDED' | 'UPDATED' | 'DELETED';
