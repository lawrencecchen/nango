...
vi.mock('crypto', () => __awaiter(void 0, void 0, void 0, function* () {
    const actualCrypto = (yield vi.importActual('crypto'));
    return Object.assign(Object.assign({}, actualCrypto), { timingSafeEqual: () => true });
}));
describe('Webhook route unit tests', () => {
    it('Should order the body accordingly based on the contact.creation', () => __awaiter(void 0, void 0, void 0, function* () {
        const nangoMock = {
        ...
        yield HubspotWebhookRouting.default(nangoMock, integration, headers, body, body.toString(), logContextGetter);
    ...
    it('Should order the body accordingly based on the foo.creation', () => __awaiter(void 0, void 0, void 0, function* () {
        const nangoMock = {
            executeScriptForWebhooks: vi.fn()
        };
        const body = [
...
//# sourceMappingURL=hubspot-webhook-routing.unit.test.js.map