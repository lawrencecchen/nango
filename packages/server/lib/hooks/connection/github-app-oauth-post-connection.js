...
export default function execute(nango) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (connection.credentials.type === 'OAUTH2') {
            updatedConfig = Object.assign(Object.assign({}, updatedConfig), { userCredentials: connection.credentials });
        }
        yield nango.updateConnectionConfig(updatedConfig);
    });
}
//# sourceMappingURL=github-app-oauth-post-connection.js.map