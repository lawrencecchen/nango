...
import { getEmailByUuid, resendVerificationEmailByUuid, resendVerificationEmailByEmail, signup, signupWithToken, signin, validateEmailAndLogin, getEmailByExpiredToken } from './controllers/v1/account/index.js';
...
if (!isCloud && !isEnterprise) {
    web.route('/api/v1/basic').get(webAuth, (_, res) => {
        res.status(200).send();
    });
}
// -------
