...
const validation = z
    ...
    .strict();
export const updateMetadata = asyncWrapper((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield connectionService.updateMetadata(validConnections, metadata);
