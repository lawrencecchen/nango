...
const validation = z
    ...
    .strict();
export const getEmailByExpiredToken = asyncWrapper((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield userService.refreshEmailVerificationToken(token);
...
//# sourceMappingURL=getEmailByExpiredToken.js.map