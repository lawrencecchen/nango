...
export declare type SyncResult = Record<string, Result>;
...
export declare type RunSyncCommand = 'PAUSE' | 'UNPAUSE' | 'RUN' | 'RUN_FULL' | 'CANCEL';
export declare const UserFacingSyncCommand: {
    PAUSE: string;
    UNPAUSE: string;
    RUN: string;
    RUN_FULL: string;
