...
exports.VerifyEmailByExpiredToken = void 0;
...
function VerifyEmailByExpiredToken() {
    ...
    (0, react_1.useEffect)(() => {
        const getEmail = () => __awaiter(this, void 0, void 0, function* () {
            const res = yield (0, api_1.apiFetch)(`/api/v1/account/email/expired-token/${token}`);
            ...
            <DefaultLayout_1.default>
                <div className="flex flex-col justify-center items-center">
                    <div className="py-3">
                        ...
                        {email || uuid ? (<form className="mt-6 space-y-6" onSubmit={resendEmail}>
...
exports.VerifyEmailByExpiredToken = VerifyEmailByExpiredToken;
//# sourceMappingURL=VerifyEmailByExpiredToken.js.map