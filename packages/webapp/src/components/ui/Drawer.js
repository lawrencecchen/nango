...
const DrawerContent = React.forwardRef((_a, ref) => {
    ...
    return (<DrawerPortal>
            <DrawerOverlay />
            <vaul_1.Drawer.Content ref={ref} className={(0, utils_1.cn)('outline-none fixed inset-x-0 bottom-0 top-0 z-50 flex flex-col bg-active-gray text-white border-l border-l-border-gray-400', className)} {...props}>
                {children}
