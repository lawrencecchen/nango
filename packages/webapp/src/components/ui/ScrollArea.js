...
const ScrollArea = React.forwardRef((_a, ref) => {
    ...
    return (<ScrollAreaPrimitive.Root ref={ref} className={(0, utils_1.cn)('relative overflow-hidden pointer-events-auto', className)} {...props}>
...
const ScrollBar = React.forwardRef((_a, ref) => {
    ...
    return (<ScrollAreaPrimitive.ScrollAreaScrollbar ref={ref} orientation={orientation} className={(0, utils_1.cn)('flex touch-none select-none transition-colors', orientation === 'vertical' && 'h-full w-2.5 border-l border-l-transparent p-[1px]', orientation === 'horizontal' && 'h-2.5 flex-col border-t border-t-transparent p-[1px]', className)} {...props}>
