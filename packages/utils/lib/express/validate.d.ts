...
export declare const validateRequest: <E extends Endpoint<any>>(parser: RequestParser<E>) => (req: EndpointRequest<E>, res: EndpointResponse<E>, next: NextFunction) => void;
export declare function zodErrorToHTTP(error: z.ZodError): ValidationError[];
/**
 * Enforce empty request body
 */
export declare function requireEmptyBody(req: Request): z.SafeParseError<{}> | undefined;
/**
 * Enforce empty request query string
 */
export declare function requireEmptyQuery(req: Request, { withEnv }?: {
    withEnv: boolean;
}): z.SafeParseError<{
