...
export declare type AuthModeType = AuthModes[keyof AuthModes];
...
export declare type AuthOperationType = AuthOperation[keyof AuthOperation];
export interface OAuthAuthorizationMethod {
    BODY: 'body';
    HEADER: 'header';
}
export declare type OAuthAuthorizationMethodType = OAuthAuthorizationMethod[keyof OAuthAuthorizationMethod];
export declare type OAuthBodyFormatType = OAuthBodyFormat[keyof OAuthBodyFormat];
...
export declare type AuthCredentials = OAuth2Credentials | OAuth1Credentials | OAuth2ClientCredentials;
...
export declare type UnauthCredentials = Record<string, never>;
export declare type RefreshTokenResponse = AuthorizationTokenResponse;
export interface AuthorizationTokenResponse extends Omit<OAuth2Credentials, 'type' | 'raw'> {
    expires_in?: number;
}
export declare type ImportedCredentials =
