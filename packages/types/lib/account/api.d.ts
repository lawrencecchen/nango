...
export declare type Signup = Endpoint<{
    Method: 'POST';
...
export declare type SignupWithToken = Endpoint<{
    Method: 'POST';
...
export declare type ValidateEmailAndLogin = Endpoint<{
    Method: 'POST';
...
export declare type ResendVerificationEmailByUuid = Endpoint<{
    Method: 'POST';
...
export declare type ResendVerificationEmailByEmail = Endpoint<{
    Method: 'POST';
...
export declare type GetEmailByUuid = Endpoint<{
    Method: 'GET';
...
export declare type GetEmailByExpiredToken = Endpoint<{
    Method: 'GET';
...
export declare type Signin = Endpoint<{
    Method: 'POST';
