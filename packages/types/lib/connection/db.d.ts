...
export declare type ConnectionConfig = Record<string, any>;
...
export declare type RecentlyCreatedConnection = Pick<StoredConnection, 'id' | 'connection_id' | 'provider_config_key'> & {
