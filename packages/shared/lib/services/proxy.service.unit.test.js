...
describe('Proxy service Construct URL Tests', () => {
    ...
    it('Should retry after', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield proxyService.retryHandler(1, 1, mockAxiosError, 'after', 'x-rateLimit-reset-after');
        const after = Date.now();
        const diff = after - before;
        expect(diff).toBeGreaterThanOrEqual(1000);
        expect(diff).toBeLessThan(2000);
    }));
    it('Should retry at', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const before = Date.now();
        yield proxyService.retryHandler(1, 1, mockAxiosError, 'at', 'x-rateLimit-reset');
        const after = Date.now();
        const diff = after - before;
...
describe('Proxy service configure', () => {
    it('Should fail if no endpoint', () => {
        ...
        expect(error === null || error === void 0 ? void 0 : error.message).toContain('missing_endpoint');
    ...
    it('Should fail if no connectionId', () => {
        ...
        expect(response).toBeNull();
        expect(error).toBeDefined();
        expect(error === null || error === void 0 ? void 0 : error.message).toContain("Missing param 'connection_id'.");
        expect(activityLogs.length).toBe(1);
        expect(activityLogs[0]).toMatchObject({
            environment_id: 1,
            activity_log_id: 1,
    ...
    it('Should fail if no providerConfigKey', () => {
        ...
        expect(response).toBeNull();
        expect(error).toBeDefined();
        expect(error === null || error === void 0 ? void 0 : error.message).toContain('missing_provider_config_key');
        expect(activityLogs.length).toBe(1);
        expect(activityLogs[0]).toMatchObject({
            environment_id: 1,
            activity_log_id: 1,
    ...
    it('Should fail if unknown provider', () => {
        ...
        expect(response).toBeNull();
        expect(error).toBeDefined();
        expect(error === null || error === void 0 ? void 0 : error.message).toContain('proxy is either not supported');
...
//# sourceMappingURL=proxy.service.unit.test.js.map