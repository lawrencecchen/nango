    ...
    integrations: {
        github: {
            ...
            'issues-lite': {
                ...
                auto_start: false,
                returns: ['GithubIssue'],
                description: "Fetches the Github issues but up to a maximum of 15 for demo\npurposes.\nDetails: limited sync, doesn't track deletes, metadata is not required.\nScope(s): repo or public_repo\n"
            },
            'list-files-sync': {
                type: 'sync',
                runs: 'every hour',
...
describe('Flow service tests', () => {
    ...
    it('Fetch a flow config by providing a name', () => {
        ...
        expect(flow === null || flow === void 0 ? void 0 : flow.models).not.toBeUndefined();
    });
...
//# sourceMappingURL=flow.service.unit.test.js.map