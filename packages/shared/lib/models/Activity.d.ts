...
export declare const logLevelValues: readonly ['info', 'debug', 'error', 'warn', 'http', 'verbose', 'silly'];
export declare type LogLevel = (typeof logLevelValues)[number];
export declare type LogAction =
    | 'account'
    | 'action'
    | 'analytics'
    | 'auth'
    ...
    | 'trigger full sync'
    | 'webhook';
export declare enum LogActionEnum {
    ACCOUNT = 'account',
    ACTION = 'action',
    ANALYTICS = 'analytics',
    AUTH = 'auth',
...
declare type Message = Record<string, unknown>;
