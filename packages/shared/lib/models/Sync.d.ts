...
export declare type SyncResultByModel = Record<string, SyncResult>;
...
export declare type SyncWithSchedule = Sync & Schedule;
...
export declare const CommandToActivityLog: {
    PAUSE: LogActionEnum;
    UNPAUSE: LogActionEnum;
    RUN: LogActionEnum;
    RUN_FULL: LogActionEnum;
    CANCEL: LogActionEnum;
};
export declare const SyncCommandToScheduleStatus: {
    PAUSE: ScheduleStatus;
    UNPAUSE: ScheduleStatus;
    RUN: ScheduleStatus;
    RUN_FULL: ScheduleStatus;
    CANCEL: ScheduleStatus;
};
